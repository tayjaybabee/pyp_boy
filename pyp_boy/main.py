...
if __name__ == '__main__':
    ...
    print("PypBoy imported! Please bear in mind that this package was made to be used as a whole application. Importing"\
          " this API is not recommended by the developer and therefore she can't promise that support will be available"\
          " for problems with importing the API!! ")
